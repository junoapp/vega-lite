...
const nearest = {
    ...
    marks: (model, selCmpt, marks) => {
        ...
        const cellDef = {
            ...
            encode: {
                update: Object.assign({ fill: { value: 'transparent' }, strokeWidth: { value: 0.35 }, stroke: { value: 'transparent' }, isVoronoi: { value: true } }, encode_1.tooltip(model, { reactiveGeom: true }))
            },
            transform: [
                {
                    type: 'voronoi',
